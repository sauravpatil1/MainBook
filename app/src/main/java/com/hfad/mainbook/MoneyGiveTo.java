...
public class MoneyGiveTo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_money_give_to);

        ListView listView = (ListView)findViewById(R.id.list_give_money);
        ...
        AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MoneyGiveTo.this,ShowAndUpdateActivity.class);
